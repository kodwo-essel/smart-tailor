    ...
    <div className="min-h-screen bg-[#F7F6F3] flex">
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <button className="w-full px-6 py-4 bg-white text-[#2F2F2F] text-base font-medium rounded-lg border-2 border-[#E5E5E5] hover:border-[#1A2A3A] transition-all flex items-center justify-center space-x-3 mb-8">
          ...
          <div className="flex items-center mb-8">
            ...
            <span className="px-4 text-sm text-[#2F2F2F]">or sign in with email</span>
            <div className="flex-1 h-px bg-[#E5E5E5]"></div>
          </div>
      ...
      <div className="hidden lg:block lg:w-1/2 relative bg-[#1A2A3A]">
        <div className="absolute inset-0 flex items-center justify-center p-12">
          <div className="max-w-lg text-center">
            <TypewriterText 
              text="Manage Your Tailoring Business with Ease"
              className="text-5xl text-white mb-6"
              style={{ fontFamily: '"Russo One", sans-serif' }}
            />
            <p className="text-xl text-white/80">
              Join thousands of professional tailors who trust Smart Tailor to organize their clients, measurements, and orders.
            </p>
          </div>
        </div>
      </div>
