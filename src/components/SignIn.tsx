    ...
    <div className="min-h-screen bg-[#F7F6F3] flex">
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-8">
        <div className="w-full max-w-md">
          ...
          <button className="w-full px-6 py-4 bg-white text-[#2F2F2F] text-sm font-medium rounded-lg border-2 border-[#E5E5E5] hover:border-[#1A2A3A] transition-all flex items-center justify-center space-x-3 mb-6">
